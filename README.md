# Netflix-tableau-dashboard-analytics
📌 Project Overview

This project is an extended version of a bootcamp assignment, where I designed and developed an interactive Tableau dashboard to analyze Netflix content data.

The goal of the project is to explore Netflix’s content library and extract meaningful insights related to content distribution, trends over time, genres, and content types (Movies vs TV Shows).
...
This project is based on a bootcamp learning assignment and has been extended independently by improving visualization design, adding insights, and structuring it as a professional portfolio project.

💡 What I Learned
Building interactive dashboards in Tableau
Designing KPI-driven visual analytics
Understanding data storytelling through visualization
Structuring business insights from raw datasets
Presenting data in a clear, decision-making format

🚀 Future Improvements
Add Python-based data preprocessing pipeline
Integrate SQL-based data querying layer
